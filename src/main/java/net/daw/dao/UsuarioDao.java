...
public class UsuarioDao {
    ...
    public ArrayList<UsuarioBean> getpage(int iRpp, int iPage) throws Exception {
        ...
        public ArrayList<UsuarioBean> getpageorder(int iRpp, int iPage, String field, String order ) throws Exception {
        String strSQL = "SELECT * FROM " + ob;
        ArrayList<UsuarioBean> alUsuarioBean;
        if (iRpp > 0 && iRpp < 100000 && iPage > 0 && iPage < 100000000) {
            strSQL += " ORDER BY " + field + " " + order +" LIMIT " + (iPage - 1) * iRpp + ", " + iRpp;
            ResultSet oResultSet = null;
            PreparedStatement oPreparedStatement = null;
            try {
                oPreparedStatement = oConnection.prepareStatement(strSQL);
                ...
                throw new Exception("Error en Dao getpageorder de " + ob , e);
            } finally {
                if (oResultSet != null) {
                    oResultSet.close();
                }
            ...
            throw new Exception("Error en Dao getpageorder de " + ob);
        }
        return alUsuarioBean;
